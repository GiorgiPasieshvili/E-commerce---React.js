          ...
          ({ loading, error, data }) => {
            ...
            return (
              <div className="products container">
                <h3 className={!category ? "no-margin" : undefined}>{category}</h3>
                      ...
                      <li key={index} >
                        <Link to={`/product/${product.id}`}>
                          ...
                          {cartItems.find(item => item.id === product.id) && ( 
                            <svg className="incart" width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
